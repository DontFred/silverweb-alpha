       ...
       data: {
        ...
        employee: {
          create: {
            ...
            avatar: "https://api.dicebear.com/6.x/avataaars/svg?seed=Mia&accessories[]&clothing=shirtCrewNeck&eyebrows=default&eyes=default,wink&facialHair=beardMedium&facialHairColor=4a312c&facialHairProbability=100&hairColor=4a312c&hatColor[]&mouth=serious&skinColor=ffdbb4&top=shortCurly",
